...
let instrucciones = ["Con las flechas de tu teclado move las piezas",
  "Sigue moviendo las piezas hasta completar el puzzle",
  "Usa la imagen de abajo como guia"];
...
function ultimaJugada (direccion) {
...
const chequearSiGano = ()=> {
  //COMPLETAR
  let posicionGrilla = 1;
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  //COMPLETAR
  let posicionTemp = grilla [filaPos1] [columnaPos1];
  grilla [filaPos1] [columnaPos1] = grilla [filaPos2] [columnaPos2]
  grilla [filaPos2] [columnaPos2] = posicionTemp;
